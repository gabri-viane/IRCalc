...
la domanda totale. Se il sistema � composto da sole macchine in serie allora la domanda viene
...
/*
Calcola l'Adjusted Takt Time, usa l'OEE calcolato, e dato che pu� differire da quello della
...
/*
Calcola il tempo di non-disponibilit� della cella: questo tempo � calcolato
usando il tempo di setup, di manuetenzione e di guasto
*/
unsigned long int getUnavailableTime(CellData* cell);

/*
Calcola la disponibilit� a seconda del solutore da usare:
...
/*
Calcola la qualit� a seconda del solutore da usare:
- CELL_SOLVER (0) nel caso di cella operata da operatori: in questo caso sono ignorati i tempi pausa e inefficienza operatore
- OPERATOR_SOLVER (1) nel caso di cella operata da operatori
- ROBOT_SOLVER (2) nel caso di cella operata da robot
*/
...
/*
Calcola l'OEE usando i valori presenti nei campi della struttura OEE. Se risult� gi� calcolato
...
/*
Calcola la produttivit� teorica e effettiva (che tiene conto dell'OEE) a secondo del
solutore scelto:
- CELL_SOLVER (0) nel caso di OEE generico della cella
- OPERATOR_SOLVER (1) nel caso di OEE dovuto agli operatori
- ROBOT_SOLVER (2) nel caso di OEE dovuto ai robot
